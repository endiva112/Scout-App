...
class CollaborativeDivisionsCollection extends StatefulWidget {
  final String listId;

  const CollaborativeDivisionsCollection({super.key, required this.listId});

  @override
  State<CollaborativeDivisionsCollection> createState() => _CollaborativeDivisionsCollectionState();
}

class _CollaborativeDivisionsCollectionState extends State<CollaborativeDivisionsCollection> {
