...
// Gasto pendiente (solo nombre, sin importe ni pagador)
class _GastoPendiente {
  final String nombre;
  const _GastoPendiente(this.nombre);
}

// Gasto abonado (con pagador e importe)
class _GastoAbonado {
  final String nombre;
...
// ── Widget principal ──────────────────────────────────────────────────────────
class InfoPagosPage extends StatelessWidget {
  const InfoPagosPage({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Tarjeta resumen mis gastos / totales
          _buildResumenCard(),
          const SizedBox(height: 10),
