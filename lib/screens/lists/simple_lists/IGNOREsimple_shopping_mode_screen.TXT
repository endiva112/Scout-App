    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Row(
            children: [
              _buildHeaderIconButton(Icons.event_note_rounded),
              const SizedBox(width: 10),
              _buildHeaderIconButton(Icons.share),
            ],
          ),
        ],
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            ...items.expand((item) sync* {
              if (item != items.first) _buildDottedDivider();
              yield _buildItemRow(item);
            }),
        ...
        children: [
          Material(
            ...
            child: Container(
              ...
              child: const Icon(Icons.draw, size: 40),
            ),
          ),
        ],
      ),
